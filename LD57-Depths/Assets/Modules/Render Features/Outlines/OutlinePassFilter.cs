...
namespace Xenon
{
    public class OutlinePassFilter : ScriptableRenderPass
    {
        ...
        public static readonly int SHOWVIEWSPACENORMAL = Shader.PropertyToID("_ShowViewSpaceNormal");
        ...
        {
            context.cmd.SetGlobalFloat(SHOWVIEWSPACENORMAL, 1);
            context.cmd.ClearRenderTarget(passData.ClearDepth, true, new Color(0, 0, 0, 0));
            context.cmd.DrawRendererList(passData.RendererListHandle);
            context.cmd.SetGlobalFloat(SHOWVIEWSPACENORMAL, 0);
        }
